    ...
    <div className="min-h-screen bg-background text-foreground">
      <main className="relative grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-[-6rem] top-20 h-[28rem] w-[28rem] rounded-full bg-sky-100 blur-[150px] dark:bg-sky-900/20" />
          <div className="absolute right-[-6rem] bottom-10 h-[24rem] w-[24rem] rounded-full bg-slate-200/80 blur-[140px] dark:bg-slate-800/30" />
        </div>
        ...
        <section className="relative hidden px-10 py-12 lg:flex lg:flex-col lg:justify-between xl:px-16">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-sky-200/80 bg-white/90 px-3 py-1 text-xs text-sky-700 shadow-sm dark:border-sky-900/70 dark:bg-slate-900/80 dark:text-sky-200">
            ...
            <p className="mt-6 max-w-lg text-base leading-relaxed text-slate-600 dark:text-slate-300">
              Rejoin your prep flow, find a peer, and step back into
              collaborative problem solving without losing momentum.
            </p>
          </div>
        </section>
          ...
          <div className="w-full max-w-md rounded-3xl border border-slate-200/90 bg-white/95 p-6 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.28)] dark:border-slate-800 dark:bg-slate-950/92 dark:shadow-none sm:p-8">
            <div className="mb-8 text-center lg:text-left">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Continue your prep journey with your account.
              </p>
            </div>
            ...
            <Button
              ...
              size="lg"
              onClick={() =>
                (window.location.href = `${USER_API_URL}/auth/google`)
              }
            >
            ...
            <Button
              ...
              size="lg"
              onClick={() =>
                (window.location.href = `${USER_API_URL}/auth/github`)
              }
            >
              <svg
